...
- Duplicate detection at ingest relies on the source system plus its external record key; sources that resend the same record produce one stored original.
