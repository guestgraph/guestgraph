...
/**
 * Immutable at every level (Constitution II): Hibernate refuses updates via
 * {@link Immutable}, and the {@code source_record_immutable} trigger enforces the
...
public class SourceRecordEntity {
    ...
    public SourceRecordEntity(UUID id, UUID tenantId, SourceSystemEntity sourceSystem, String externalKey,
            String payload, Map<String, Object> extracted, Instant recordTimestamp, boolean needsReview,
            List<String> needsReviewReasons, Instant receivedAt) {
        this.id = id;
