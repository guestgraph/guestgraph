...
class AuthenticationTest extends PostgresIntegrationTest {
    ...
    void missingApiKeyIsRejectedWithProblemDetails() {
        ResponseEntity<String> response = api(null).get().uri("/api/v1/guests/00000000-0000-0000-0000-000000000000")
    ...
    void unknownApiKeyIsRejected() {
        ResponseEntity<String> response = api("not-a-real-key").get()
