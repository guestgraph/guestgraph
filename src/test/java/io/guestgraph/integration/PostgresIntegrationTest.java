...
/**
 * Shared Testcontainers harness: one PostgreSQL container for the whole test run,
 * Flyway-migrated schema, two seeded tenants (isolation testing), and an
 * API-key-authenticated HTTP client that never throws on 4xx/5xx so tests can
